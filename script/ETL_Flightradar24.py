...
def extraction_transform():
    ...
    if os.path.isdir("Log/"+str(current_datetime.year)+str(current_datetime.month).zfill(2)+str(current_datetime.day).zfill(2)) == False:
        os.mkdir("Log/"+str(current_datetime.year)+str(current_datetime.month).zfill(2)+str(current_datetime.day).zfill(2))
